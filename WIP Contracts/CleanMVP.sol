 ...
 */
contract HdgMVP is ERC20, Ownable, IOrderCallbackReceiver {
    ...
    // Event to log withdrawals by user from Hedge contract
     ...
     */
    constructor() ERC20("HdgMVP", "HMVP") Ownable(msg.sender) {}
     ...
     * @param shares The amount of vault shares to be converted, denominated in 1e18
     * @return The equivalent USD value, denominated in 1e30
     */
    function sharesToUsd(uint256 shares) internal pure returns (uint256) {
        return shares * 1e12;
    }
    ...
    function _unHedge(
        ...
        uint256 shares = usdToShares(orderParams.numbers.sizeDeltaUsd);
