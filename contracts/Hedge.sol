...
contract Hedge is NectarVault, IOrderCallbackReceiver {
    ...
    function afterOrderExecution(
        ...
        if (order.orderType == 2) {
            ...
            // Update state of account shares
            sharesToBurn[_account] += order.numbers.sizeDeltaUsd;
        }
    }
