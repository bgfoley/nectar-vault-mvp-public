...
const HEDGE_VAULT = '0x9Fc0C61ea93A0eB8a567E325fE532808c4eb7CA8';
...
async function main() {
    ...
    console.log('minimumOut:', minimumOutWei.toString());
    console.log('acceptablePrice:', acceptablePrice.toString());
...
*/
            ...
            let gasEstimate;
            try {
                gasEstimate = await hedgeContract.estimateGas.unHedge(sharesWei, minimumOutWei, acceptablePrice, { value: EXECUTION_FEE });
                console.log(`Estimated gas: ${gasEstimate.toString()}`);
            } catch (estimateError) {
                console.error('Gas estimation failed:', estimateError);
                console.log('Proceeding with a fixed gas limit of 3000000');
                gasEstimate = BigInt(3000000);
            }

            // Call the unHedge function
            const tx = await hedgeContract.unHedge(sharesWei, minimumOutWei, acceptablePrice, { value: EXECUTION_FEE, gasLimit: 3000000n });
