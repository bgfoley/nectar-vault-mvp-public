...
async function main() {
    ...
    const ethPriceUsd = ethPrice * BigInt(10 ** 12); // Adjusted to 1e18 precision
    ...
    // Adjusting minimumSharesOut to have precision of 1e18
    const minimumSharesOut = (depositWei * ethPriceUsd) / BigInt(1e36);
