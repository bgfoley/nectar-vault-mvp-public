...
const HEDGE_VAULT = '0xf0047bABecACfb0c4651b6e0CcADB7f89D0DA96c';
const EXECUTION_FEE = 78000000000000n; // Assumed execution fee in wei
...
async function main() {
    ...
    if (execute.toLowerCase() === 'y') {
        try {
            const tx = await hedgeContract.hedge(depositWei, minimumSharesOut, acceptablePrice, { value: depositWei + EXECUTION_FEE });
